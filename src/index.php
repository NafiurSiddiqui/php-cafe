<?php
$items = [['name' => 'Pizza', 'icon' => '🍕'], ['name' => 'Pasta', 'icon' => '🍝']];
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="borderTest h-screen flex justify-center pt-8">
	<section class="border-2 border-slate-300 p-4 align-top max-h-[60%] w-[60%]">
		...
		<form action="./processorder.php" method="post" class="divide-y-2">
			...
			<button type="submit" value="submit" class="w-24 px-4 py-1 rounded-sm mt-4 bg-blue-600 text-white hover:bg-blue-700 font-semibold">
				Order
			</button>
		</form>
	</section>
